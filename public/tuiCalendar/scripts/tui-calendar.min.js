...
!(function (e, t) {
  ...
  return (function (e) {
      ...
      var s = (l = {
          ...
          find: function (e, t, n) {
            ...
            return (
              ...
              (function e(t, a) {
                for (
                  var u, c = t.childNodes, d = 0, h = c.length;
                  d < h;
                  d += 1
                )
                  if ('#text' !== (u = c[d]).nodeName)
                    if (l._matcher(u, a)) {
                      if ((((s && n(u)) || !s) && o.push(u), r)) {
                        i = !0;
                        break;
                      }
                    } else if (u.childNodes.length > 0 && (e(u, a), i)) break;
          ...
          (l = {
            ...
            range: function (e, t, n) {
              for (
                ...
                c.push(l.start(u.d)), (s += n), u.addDate(1);
              return c;
            },
            clone: function (e) {
              return new i(e);
            ...
            arr2dCalendar: function (e, t, n) {
              ...
              return (
                S
                  ? ((s = new i(e)),
                    (u = a(new i(e))).addDate(7 * (S - 1)),
                    (u = u.d))
                  : ((s = l.startDateOfMonth(e)), (u = l.endDateOfMonth(e))),
                (o = r.range(g, 7).concat(r.range(7)).slice(0, 7)),
                (c = r.inArray(s.getDay(), o)),
                (h = 7 - (r.inArray(u.getDay(), o) + 1)),
                (d = S ? 7 * S : y ? 42 : c + u.getDate() + h),
                (p = l.start(s).addDate(-c)),
            ...
            renderEnd: function (e, t) {
              var n = l.getDateDifference(e, t);
              return Math.abs(n) >= 1 && l.isStartOfDay(t)
                ? l.convertStartDayToLastDay(t)
                : l.end(t);
            }
          }),
          (e.exports = l);
    ...
    function (e, t, n) {
      ...
      function C() {
        return i.isNumber(l) ? l : new Date().getTimezoneOffset();
      }
      function v(e) {
        o = e;
      }
      ...
      (S.prototype.getTime = function () {
        ...
        (S.prototype.setWithRaw = function (e, t, n, l, o, i, a) {
        ...
        (e.exports = {
          ...
          isDifferentOffsetStartAndEndTime: function (e, t) {
            ...
            return (
              n > l ? (i = 1) : n < l && (i = -1),
              { isOffsetChanged: i, offsetDiff: n - l }
            );
          },
          setPrimaryTimezoneCode: v
        });
    },
    function (e, t, n) {
      'use strict';
    ...
    function (e, t, n) {
      ...
      (d.schema = { required: ['title'], dateRange: ['start', 'end'] }),
        ...
        (d.prototype.setAllDayPeriod = function (e, t) {
          (e =
            l.isString(e) && 10 === e.length
              ? i.parse(e)
              : new s(e || Date.now())),
            l.isString(t) && 10 === t.length
        ...
        (d.prototype.duration = function () {
          var e = this.getStarts(),
            t = this.getEnds(),
            n = o.hasPrimaryTimezoneCustomSetting();
          return this.isAllDay
            ? i.end(t) - i.start(e)
            : n && o.isPrimaryUsingDSTTimezone()
            ? (function (e, t) {
                var n = o.isDifferentOffsetStartAndEndTime(
                    e.getTime(),
                    t.getTime()
                  ),
                  l = t - e;
                return 0 !== n.isOffsetChanged && (l += 6e4 * n.offsetDiff), l;
              })(e, t)
            : n && o.isNativeOsUsingDSTTimezone()
            ? (function (e, t) {
                var n = e.toDate().getTimezoneOffset(),
                  l = t.toDate().getTimezoneOffset();
                return t - e + 6e4 * (l - n);
              })(e, t)
            : t - e;
        }),
        (d.prototype.collidesWith = function (e) {
          var t = this.getStarts(),
            ...
            c = i.millisecondsFrom('minutes', e.comingDuration);
          return (
            Math.abs(n - t) < u && (n += u),
            Math.abs(o - l) < u && (o += u),
            (n += r),
        ...
        c = {
          _retriveScheduleData: function (e, t) {
            ...
            return (
              ...
              (r = o.getSize(n)[0]),
              (c = i.getMousePosition(t, n)),
              (h = d(p, a.ratio(r, 100, c[0]))),
              function (t) {
                var o = i.getMousePosition(t, n)[0],
                  c = d(p, a.ratio(r, 100, o));
                return (
                  (c = s(c, 0)),
                  (c = u(c, l - 1)),
                  {
        ...
        u = {
          ...
          _retriveScheduleData: function (e) {
            ...
            return function (m, f) {
              var g = r.n(a.getMousePosition(m, n)).y,
                ...
                _ = t._calcGridYIndex(p, c, g),
                C = new s(d).addMinutes(i.minutesFromHours(_ + u.hourStart));
              return l.extend(
                {
          ...
          _retriveScheduleDataFromDate: function (e, t, n, l) {
            ...
            return {
              target: e,
              relatedView: e,
              gridY: (o = t.getHours() - l + c(t.getMinutes())),
              timeY: new s(u).addMinutes(i.minutesFromHours(o)),
              nearestGridY: (a = o),
              nearestGridTimeY: new s(u).addMinutes(i.minutesFromHours(a)),
              nearestGridEndY: (r = n.getHours() - l + c(n.getMinutes())),
              nearestGridEndTimeY: new s(u).addMinutes(i.minutesFromHours(r)),
              triggerEvent: 'manual',
              hourStart: l
            };
          },
      ...
      e.exports = function (e) {
        ...
        return function (e) {
          var t,
            ...
            g = (function (e) {
              for (var t, n = 0, l = p.length; n < l; n += 1)
                if ((t = p[n]).left <= e && e <= t.left + t.width) return n;
              return e < 0 ? -1 : n;
            })(o.ratio(h[0], 100, f[0])),
            y = s(o.ratio(h[1], u, f[1]));
          return (
            y < 0 && (y = 0),
      ...
      (a.create = function (e) {
        ...
        (a.prototype.collidesWith = function (e) {
          var t = this.getStarts(),
            ...
            u = o.millisecondsFrom('minutes', e.valueOf().goingDuration),
            c = o.millisecondsFrom('minutes', e.valueOf().comingDuration);
          return (
            Math.abs(n - t) < i && (n += i),
            Math.abs(a - l) < i && (a += i),
            (n += s),
    ...
    function (e, t, n) {
      ...
      l.inherit(h, s),
        ...
        (h.prototype._resize = function (e, t, n) {
          ...
          for (
            i = (o = this[s ? 'prevPanel' : 'nextPanel'](
              e
            )).getResizeInfoByGrowth(a),
              r.push([o, i[0]]),
              o = this[u](o);
            l.isExisty(o);
            o = this[u](o)
    ...
    function (e, t, n) {
      ...
      l.inherit(u, s),
              ...
              dates: l.map(
                ...
                function (e, t) {
                  ...
                  return {
                    ...
                    left: i[t] ? i[t].left : 0,
                    color: this._getDayNameColor(u, n, o),
                    backgroundColor: this._getDayBackgroundColor(u, n)
                  };
                },
                this
              )
        ...
        (u.prototype._getDayNameColor = function (e, t, n, l) {
          var o = '';
          return (
            e &&
              (o =
    ...
    function (e, t, n) {
      ...
      i.inherit(f, l),
        (f.prototype._onMouseDown = function (e) {
          var t = u.getEventTarget(e);
          c.closest(t, s.classname('.floating-layer')) || this.hide();
        }),
        ...
        (f.prototype._closePopup = function (e) {
          ...
          return (
            !(!c.hasClass(e, t) && !c.closest(e, '.' + t)) && (this.hide(), !0)
          );
        }),
        (f.prototype._toggleDropdownMenuView = function (e) {
          var t = s.classname('dropdown-button'),
            n = c.hasClass(e, t) ? e : c.closest(e, '.' + t);
          return (
            !!n &&
            (c.hasClass(n.parentNode, s.classname('open'))
        ...
        (f.prototype._closeDropdownMenuView = function (e) {
          (e = e || this._focusedDropdown) &&
            (c.removeClass(e, s.classname('open')),
            (this._focusedDropdown = null));
        }),
        (f.prototype._openDropdownMenuView = function (e) {
          c.addClass(e, s.classname('open')), (this._focusedDropdown = e);
        }),
        (f.prototype._selectDropdownMenuItem = function (e) {
          var t,
            ...
            u = c.hasClass(e, i) ? e : c.closest(e, '.' + i);
          return (
            !!u &&
            ((t = c.find('.' + a, u).style.backgroundColor || 'transparent'),
            (n = c.find('.' + r, u).innerHTML),
            (l = c.closest(u, s.classname('.dropdown'))),
            (o = c.find(s.classname('.dropdown-button'), l)),
            (c.find('.' + r, o).innerText = n),
            c.hasClass(l, s.classname('section-calendar')) &&
              ((c.find('.' + a, o).style.backgroundColor = t),
              (this._selectedCal = d.find(this.calendars, function (e) {
                return e.id === c.getData(u, 'calendarId');
              }))),
            c.removeClass(l, s.classname('open')),
            !0)
          );
        }),
        (f.prototype._toggleIsAllday = function (e) {
          var t,
            ...
            l = c.hasClass(e, n) ? e : c.closest(e, '.' + n);
          return (
            !!l &&
            (((t = c.find(
        ...
        (f.prototype._toggleIsPrivate = function (e) {
          ...
          return (
            !!n &&
            (c.hasClass(n, s.classname('public'))
              ? c.removeClass(n, s.classname('public'))
              : c.addClass(n, s.classname('public')),
            !0)
          );
        }),
        (f.prototype._onClickSaveSchedule = function (e) {
          var t,
            ...
            u = s.cssPrefix;
          return (
            !(!c.hasClass(e, r) && !c.closest(e, '.' + r)) &&
            ((t = c.get(u + 'schedule-title')),
            (n = new m(this.rangePicker.getStartDate())),
            (l = new m(this.rangePicker.getEndDate())),
            this._validateForm(t, n, l)
              ? ((a = !!c.get(u + 'schedule-allday').checked),
                (o = this._getRangeDate(n, l, a)),
                (i = {
                  calendarId: this._selectedCal ? this._selectedCal.id : null,
                  title: t,
                  location: c.get(u + 'schedule-location'),
                  start: o.start,
                  end: o.end,
                  isAllDay: a,
                  state: c.get(u + 'schedule-state').innerText,
                  isPrivate: !c.hasClass(
                    c.get(u + 'schedule-private'),
                    s.classname('public')
                  )
                }),
                this._isEditMode
        ...
        (f.prototype.render = function (e) {
          ...
          (e.zIndex = this.layer.zIndex + 5),
            ...
            i.debounce(function () {
              u.on(document.body, 'mousedown', a._onMouseDown, a);
            })();
        }),
        (f.prototype._makeEditModeData = function (e) {
          ...
          return (
            ...
            (a = s.isAllDay),
            (r = s.state),
            (e.selectedCal = this._selectedCal = d.find(
              this.calendars,
              function (t) {
        ...
        (f.prototype._setPopupPositionAndArrowDirection = function (e) {
          var t = c.find(s.classname('.popup'), this.layer.container),
        ...
        (f.prototype._setArrowDirection = function (e) {
          var t = e.direction || 'arrow-bottom',
            n = c.get(s.classname('popup-arrow')),
            l = c.find(s.classname('.popup-arrow-border', n));
          t !== s.classname('arrow-bottom') &&
            (c.removeClass(n, s.classname('arrow-bottom')),
            c.addClass(n, s.classname(t))),
      ...
      i.inherit(p, l),
        ...
        (p.prototype._getScheduleModel = function (e) {
          var t,
            n,
            l = i.extend({}, e),
            o = h.start(e.start).toDate().getTimezoneOffset(),
            a = c.getNativeOffsetMs(),
            r = c.hasPrimaryTimezoneCustomSetting(),
            s = l.start.toDate().getTimezoneOffset(),
            u = l.end.toDate().getTimezoneOffset(),
            p = c.getPrimaryTimezoneName(),
            m = c.getPrimaryOffset(),
            f = c.getOffsetByTimezoneName(p, l.start.getTime()),
            g = c.getOffsetByTimezoneName(p, l.end.getTime()),
            y = 0;
          return (
            r &&
              ...
              a !== o &&
              ((y = 6e4 * s - a),
              (t = new d(l.start)).addMilliseconds(y),
              (l.start = t),
              (y = 6e4 * u - a),
              (n = new d(l.end)).addMilliseconds(y),
              (l.end = n)),
            r &&
        ...
        (p.prototype._setPopupPositionAndArrowDirection = function (e) {
          ...
          (this._scheduleEl = u),
            (t = this._calcRenderingData(l, o, c)),
            this.layer.setPosition(t.x, t.y),
            this._setArrowDirection(t.arrow);
        }),
        (p.prototype._getYAndArrowTop = function (e, t, n, l, o) {
          var i, a, r;
          return (
            (a = (i = ((e = e < 0 ? 0 : e) + t) / 2) - n / 2) < l
              ? ((a = 0), (r = i - l - 8))
              : a + n > o
              ? (r = i - (a = Math.max(o - n - l, 0)) - l - 8)
              : (a -= l),
            (r < 0 || r > n) && (r = null),
            { y: a, arrowTop: r }
          );
        }),
        (p.prototype._getXAndArrowDirection = function (e, t, n, l, o) {
          var i = 'arrow-left',
            a = t;
          return (
      ...
      (c.prototype.destroy = function () {
        ...
        (c.prototype._onDragStart = function (e) {
          var t,
            ...
            s,
            u = e.target,
            c = this.checkExpectedCondition(u),
            d = this.controller;
          c &&
            (t = a.closest(u, o.classname('.weekday-schedule-block'), !0)) &&
            ((n = a.getData(t, 'id')),
      ...
      (p.prototype.destroy = function () {
        ...
        (p.prototype._getCoordByDate = function (e) {
          for (
            var t = this.weeks,
              ...
              s = e < i,
              u = new r(i),
              c = new r(i).addDate(s ? -n : n).addDate(-1),
              p = o(e, u),
              m = 0;
            !a.isBetweenWithDate(e, u, c);

          )
            u.addDate(s ? -n : n),
              (c = new r(u).addDate(n - 1)),
              (p = o(e, u)),
              (m += s ? -1 : 1);
          return [p, m];
        }),
        ...
        (p.prototype.start = function (e) {
          var t,
            ...
            s = e.x,
            u = e.y,
            c = new r(this.view.options.renderMonth);
          n.isCreationMode
            ? i &&
              !a.isSameMonth(c, i.start) &&
              (i.start.setMonth(c.getMonth()),
              i.start.setDate(1),
              i.end.setMonth(c.getMonth()),
              i.end.setDate(1))
            ...
            (l.isUndefined(s) || l.isUndefined(u)) &&
              ((s = (t = this._getCoordByDate(i.getStarts()))[0]), (u = t[1])),
            (this.startCoord = [s, u]),
            this.update(s, u);
        }),
        (p.prototype._updateGuides = function (e) {
          l.forEach(e, function (e) {
            ...
            (t.style.display = 'block'),
              ...
              e.exceedR ? i.addClass(t, l) : i.removeClass(t, l);
          });
        }),
        ...
        (p.prototype.update = function (e, t) {
          var n = this,
            ...
            s = l.range(c(o[1], a[1]), u(o[1], a[1]) + 1),
      ...
      (y.prototype.destroy = function () {
        ...
        (y.prototype._initialize = function (e) {
          ...
          (this._options = l.extend(
            ...
            (this._options.timezone = l.extend(
              { zones: [] },
              l.pick(e, 'timezone') || {}
            )),
        ...
        (y.prototype._setAdditionalInternalOptions = function (e) {
          ...
          l.forEach(e.template, function (e, t) {
            ...
            i &&
              ...
              l.isFunction(n) && h.setOffsetCalculator(n),
              (t = i.zones).length &&
                (h.setPrimaryTimezoneByOption(t[0]),
                l.isNumber(t[0].timezoneOffset) &&
        ...
        (y.prototype._getWeekDayRange = function (e, t, n) {
          ...
          return (
            (t = t || 0),
            (o = (e = l.isDate(e) ? e : new p(e)).getDay()),
            (i = new p(e).addDate(-o + t)),
            (r = new p(i).addDate(6)),
            o < t && ((i = new p(i).addDate(-7)), (r = new p(r).addDate(-7))),
            n &&
          ...
          (e = l.isExisty(e) ? e : 0),
            'month' === m
              ? ((r = l.pick(this._options, 'month', 'startDayOfWeek') || 0),
                ...
                (u = l.pick(this._options, 'month', 'workweek') || !1),
                (c = l.pick(this._options, 'month', 'isAlways6Week')),
                s
                  ? ((d = {
                      startDayOfWeek: r,
                      isAlways6Week: !1,
                    ...
                    (o = a.arr2dCalendar(h.d, d)),
                    y(f, function (e, t) {
                      t.renderMonth = new p(h.d);
                    }))
                  : ((d = { startDayOfWeek: r, isAlways6Week: c, workweek: u }),
                    h.addMonth(e),
                    (o = a.arr2dCalendar(h.d, d)),
                    y(f, function (e, t) {
                      t.renderMonth = new p(h.d);
              ...
              ? (h.addDate(7 * e),
                ...
                (u = l.pick(this._options, 'week', 'workweek') || !1),
                (o = this._getWeekDayRange(h.d, r, u)),
                (t = o[0]),
                (n = o[1]),
                y(f, function (e, l) {
                  (l.renderStartDate = new p(t)),
                    (l.renderEndDate = new p(n)),
          ...
          var l = {
            ...
            lookupProperty: function (e, t) {
              ...
              return null == n ||
                ...
                c.resultIsAllowed(n, l.protoAccessControl, t)
                ? n
                : void 0;
            },
            lookup: function (e, t) {
            ...
            (i._setup = function (i) {
              if (i.partial)
                ...
                !(function (e, t) {
                  ...
                  (l.hooks = {}),
                  (l.protoAccessControl = c.createProtoAccessControl(i));
        ...
        (l = {
          supportIntl: function () {
            return (
              ...
              o.isFunction(Intl.DateTimeFormat.prototype.formatToParts)
            );
          },
          offsetCalculator: function (e, t) {
            ...
            return -(function (e, t) {
              var n = e[0],
                ...
                a = e[4],
                r = e[5],
                s = (new Date(Date.UTC(n, l - 1, o, i, a, r)) - t) / 60 / 1e3;
              return Math.round(s);
            })(
              (function (e, t) {
                var n,
                ...
                for (n = 0; n < s; n += 1)
                  (l = a[i[n].type]),
                    o.isUndefined(l) || (r[l] = parseInt(i[n].value, 10));
                return r;
              })(n, l),
              l
            );
    ...
    function (e, t, n) {
      ...
      (d.prototype._getContainDatesInSchedule = function (e) {
        var t,
          n = e.getStarts(),
          l = e.getEnds(),
          o = a.start(n),
          i = 0 === a.compare(n, l) ? l : a.convertStartDayToLastDay(l),
          r = a.end(i);
        return (
          u.hasPrimaryTimezoneCustomSetting() &&
            ((o = (t = (function (e) {
              var t = e.getStarts(),
                ...
                o = (a.end(l), u.getNativeOffsetMs()),
                i = t.toDate().getTimezoneOffset(),
                r = 0,
                s = u.getPrimaryTimezoneName(),
                d = u.getPrimaryOffset(),
                h = u.getOffsetByTimezoneName(s, t.getTime());
              return (
                u.isNativeOsUsingDSTTimezone() && o !== i && (r = 6e4 * i - o),
                u.isPrimaryUsingDSTTimezone() && d !== h && (r = 6e4 * (d - h)),
                {
                  start: a.start(t.getUTCTime() + r),
                  end: a.end(
                    a.convertStartDayToLastDay(new c(n.getUTCTime() + r))
                  )
                }
              );
            })(e)).start),
            (r = t.end)),
          a.range(o, r, a.MILLISECONDS_PER_DAY)
        );
      }),
        (d.prototype.createSchedule = function (e, t) {
          var n,
            l = { data: e };
        ...
        (d.prototype.createSchedules = function (e, t) {
          var n = this;
          return l.map(e, function (e) {
            return n.createSchedule(e, t);
          });
        }),
        (d.prototype.updateSchedule = function (e, t) {
        ...
        (d.prototype.deleteSchedule = function (e) {
          return this._removeFromMatrix(e), this.schedules.remove(e), e;
        }),
        (d.prototype._addToMatrix = function (e) {
        ...
        (d.prototype._removeFromMatrix = function (e) {
          var t = l.stamp(e);
          l.forEach(
            this.dateMatrix,
            function (e) {
        ...
        (d.prototype.addSchedule = function (e, t) {
          return (
        ...
        (d.prototype.splitScheduleByDateRange = function (e, t, n) {
        ...
        (d.prototype.findByDateRange = function (e, t) {
          var n,
            o,
            s,
            u = a.range(a.start(e), a.end(t), a.MILLISECONDS_PER_DAY),
            c = this.schedules.items,
            d = this.dateMatrix,
            h = a.format,
            p = {};
          return (
        ...
        (d.prototype.clearSchedules = function () {
          (this.dateMatrix = {}),
            this.schedules.clear(),
            this.fire('clearSchedules');
        }),
        (d.prototype.setTheme = function (e) {
          return this.theme.setStyles(e);
        }),
        (d.prototype.setCalendars = function (e) {
          this.calendars = e;
        }),
      ...
      var l = n(0),
        ...
        d = {
          ...
          getMatrices: function (e, t) {
            ...
            return (
              o(t, function (t) {
                var a = [[]];
                o(t, function (t) {
                  for (var n, o, r = e.items[t], s = 0, u = !1; !u; )
                    !1 === (o = i(a, s))
                      ? (a[0].push(r), (u = !0))
                ...
                r.hasPrimaryTimezoneCustomSetting() &&
                  ((l = (function (e, t) {
                    var n = r.getNativeOffsetMs(),
                      l = e.toDate().getTimezoneOffset(),
                      o = 0,
                      i = r.getPrimaryTimezoneName(),
                      a = r.getPrimaryOffset(),
                      u = r.getOffsetByTimezoneName(i, e.getTime());
                    ...
                    r.isPrimaryUsingDSTTimezone() &&
                      ...
                      (o = 6e4 * (a - u));
                    return {
                      start: new s(e.getUTCTime() + o),
                      end: new s(t.getUTCTime() + o)
                    };
                  })(o, i)),
                  (o = l.start),
                  (i = l.end)),
          ...
          limitRenderRange: function (e, t, n) {
            ...
            return n.constructor === u ? (n.each(l), null) : l(n);
          },
      ...
      var l = n(0),
        ...
        u = {
          ...
          hasCollide: function (e, t, n) {
            ...
            return (
              !!e.length &&
              ((l = u(i.bsearch(e, t, s(0), c))),
              (o = u(i.bsearch(e, t, s(1), c))),
              (a = u(i.bsearch(e, n, s(0), c))),
              (r = u(i.bsearch(e, n, s(1), c))),
              !(l === o && o === a && a === r))
            );
          },
          ...
          getViewModelForTimeView: function (e, t, n, o, i) {
            var a = this,
              ...
              s = {},
              c = u._makeGetViewModelFuncForTimeView(o, i);
            return (
          ...
          _makeHourRangeFilter: function (e, t) {
            return function (n) {
              var l = n.model.start,
                ...
                a = l.getMonth(),
                s = l.getDate(),
                u = new r(i, a, s).setHours(e),
                c = new r(i, a, s).setHours(t);
              return (
                (l >= u && l < c) ||
                (o > u && o <= c) ||
                (l < u && o > u) ||
          ...
          findByDateRange: function (e, t, n, i, a) {
            var r,
              ...
              u = this.Core,
              c = this.Week,
              d = u.getScheduleInDateRangeFilter(e, t),
              h = l.pluck(n, 'name'),
            ...
            return (
              ...
              l.forEach(n, function (n) {
                var l = n.name;
                'daygrid' === n.type
                  ? (s[l] = c.getViewModelForAlldayView(e, t, s[l]))
                  : 'timegrid' === n.type &&
                    (s[l] = c.getViewModelForTimeView(e, t, s[l], p, m));
              }),
              s
            );
          },
        ...
        s = {
          ...
          _stackTimeFromTop: function (e) {
            ...
            a.forEach(function (e) {
              ...
              if (
                ...
                for (
                  t = r.apply(null, c) + 1, o = 1;
                  o <= t && ((e.top = o), !(l.inArray(e.top, c) < 0));
                  o += 1
                );
              c.push(e.top);
            });
          ...
          _addMultiDatesInfo: function (e) {
            e.each(function (e) {
              var t = e.model,
                n = t.getStarts(),
                l = t.getEnds();
              (e.hasMultiDates = i.hasMultiDates(n, l)),
                !t.isAllDay &&
                  e.hasMultiDates &&
                  ((e.renderStarts = i.start(n)),
                  (e.renderEnds = i.renderEnd(n, l)));
            });
          },
          findByDateRange: function (e, t, n, l) {
            ...
            return (
              ...
              (u = d.getCollisionGroup(s)),
              (c = d.getMatrices(r, u)),
              d.positionViewModels(e, t, c, h._weightTopValue),
    ...
    function (e, t, n) {
      ...
      e.exports = function (e, t, n, y, S) {
        ...
        return (
          ...
          ((_ = new c(null, y.week, t, H, S)).handler = {
            click: {},
            dayname: {},
            creation: {},
            move: {},
          ...
          }),
          {
            ...
            openCreationPopup: function (e) {
              P &&
                (e.isAllDay
                  ? _.handler.creation.allday.invokeCreationClick(u.create(e))
                  : _.handler.creation.time.invokeCreationClick(u.create(e)));
            },
      ...
      l.inherit(u, s),
        (u.prototype.render = function () {
          var e,
            ...
            g = this.state;
          (e = new r(c.renderStartDate)),
            (t = new r(c.renderEndDate)),
          ...
          return l.map(
            ...
            function (e, t) {
              ...
              return {
                ...
                color: this._getDayNameColor(i, l, r, u)
              };
            },
            this
          );
    ...
    function (e, t, n) {
      ...
      l.inherit(f, u),
        (f.prototype.getBaseViewModel = function (e) {
          ...
          return (
            d.showExpandableButton &&
              ...
              f &&
                ((c = this.parent.controller.getExceedDate(t, u, e.range)),
        ...
        (f.prototype.render = function (e) {
          ...
          (l.innerHTML = d(i)),
            this.children.clear(),
            (t = new c(n, r.find(o.classname('.container'), l))),
            this.addChild(t),
      ...
      e.exports = (l.default || l).template({
        ...
        4: function (e, t, n, l, o) {
          ...
          return (
            ...
            u(
              c(null != (i = null != t ? d(t, 'model') : t) ? d(i, 'id') : i, t)
            ) +
            '" data-calendar-id="' +
            u(
              c(
            ...
            (i = d(n, 'if').call(
              ...
              : '') +
            '"\n            style="height:' +
            u(c((i = o && d(o, 'root')) && d(i, 'scheduleHeight'), t)) +
            'px; line-height:' +
            u(c((i = o && d(o, 'root')) && d(i, 'scheduleHeight'), t)) +
            'px; border-radius: ' +
            u(
          ...
          return (
            ...
            u(
              'function' ==
                typeof (a =
                  null !=
                  (a = c(n, 'collapsed') || (null != t ? c(t, 'collapsed') : t))
                    ? a
                    : s)
                ? a.call(r, {
                    name: 'collapsed',
            ...
            u(
              e.lambda(
                (i = o && c(o, 'root')) && c(i, 'scheduleContainerTop'),
                t
              )
            ) +
            'px;">\n' +
      ...
      e.exports = (l.default || l).template({
        1: function (e, t, n, l, o) {
          ...
          return (
            ...
            u(
              'function' ==
                typeof (a =
                  null != (a = c(n, 'left') || (null != t ? c(t, 'left') : t))
                    ? a
                    : s)
                ? a.call(r, {
                    name: 'left',
            ...
            u(
              'function' ==
                typeof (a =
                  null != (a = c(n, 'width') || (null != t ? c(t, 'width') : t))
                    ? a
                    : s)
                ? a.call(r, {
                    name: 'width',
            ...
            ';\n' +
            (null !=
            (i = c(n, 'unless').call(r, o && c(o, 'last'), {
              name: 'unless',
              hash: {},
              fn: e.program(2, o, 0),
              inverse: e.noop,
        ...
        7: function (e, t, n, l, o) {
          ...
          return (
            ...
            u(
              (c(n, 'getRight') || (t && c(t, 'getRight')) || s).call(
                r,
                null != t ? c(t, 'left') : t,
                null != t ? c(t, 'width') : t,
                {
            ...
            (null !=
            (i = (
              c(n, 'weekGridFooterExceed-tmpl') ||
              (t && c(t, 'weekGridFooterExceed-tmpl')) ||
              s
            ).call(r, null != t ? c(t, 'hiddenSchedules') : t, {
          ...
          return (
            ...
            (i =
              ...
              typeof (a =
                null !=
                (a =
                  c(n, 'collapseBtnTitle-tmpl') ||
                  (null != t ? c(t, 'collapseBtnTitle-tmpl') : t))
                  ? a
                  : s)
                ? a.call(r, {
    ...
    function (e, t, n) {
      ...
      function _(e, t) {
        var n = u.getPrimaryOffset();
        return l.isString(e.timezoneName)
          ? -u.getOffsetByTimezoneName(e.timezoneName, t)
          : l.isNumber(e.timezoneOffset) && e.timezoneOffset !== n
          ? e.timezoneOffset
          : -n;
      }
      function C(e, t, n) {
        ...
        (n.style.position = 'relative'),
          ...
          this.options.timezones.length < 1 &&
            (this.options.timezones = [
              { timezoneOffset: u.getPrimaryOffset() }
            ]),
          (this.intervalID = 0),
          (this.timerID = 0),
      ...
      l.inherit(C, d),
        ...
        (C.prototype._beforeDestroy = function () {
          clearInterval(this.intervalID),
            ...
            c.cancelAnimFrame(this.rAnimationFrameID),
          ...
          return (
            l.forEach(a, function (t, l) {
              var r,
                ...
                f = _(t, u.getTime()) + i,
                g = S(o, e >= 0, f, n);
              u.setMinutes(u.getMinutes() + f),
                (r = s.getDateDifference(u, p)),
        ...
        (C.prototype._renderChildren = function (e, t, n, i) {
          var r,
            u,
            c,
            d,
        ...
        (C.prototype.refreshHourmarker = function () {
          ...
          t &&
            ...
            (this.rAnimationFrameID = c.requestAnimFrame(function () {
              var r = !1;
        ...
        (C.prototype.scrollToNow = function () {
          ...
          this.hourmarkers &&
            ...
            (o = function () {
              n > e - l
                ? ((n -= 10), (i.scrollTop = n), c.requestAnimFrame(o))
                : (i.scrollTop = e - l);
            }),
            c.requestAnimFrame(o));
        }),
        ...
        (h.prototype._getScheduleViewBoundY = function (e, t) {
          var n,
            ...
            y = (function (e, t) {
              var n = i.millisecondsFrom('minutes', e.valueOf().goingDuration),
                l = t.todayStart.toDate().getTimezoneOffset(),
                o = u.getNativeOffsetMs(),
                a = e.valueOf().start.toDate().getTimezoneOffset(),
                r = u.getPrimaryOffset(),
                s = u.getOffsetByTimezoneName(
                  u.getPrimaryTimezoneName(),
                  e.valueOf().start.getTime()
                ),
                c = e.valueOf().start - n - t.todayStart;
              return (
                u.hasPrimaryTimezoneCustomSetting() &&
          ...
          return (
            ...
            l + n > c && ((l = c - n), (p = !0)),
            {
              top: n,
              height:
                Math.max(l, this.options.minHeight) -
                this.options.defaultMarginBottom,
              modelDurationHeight: a,
              goingDurationHeight: o,
      ...
      e.exports = (l.default || l).template({
        ...
        19: function (e, t, n, l, o) {
          ...
          return (
            ...
            u(
              'function' ==
                typeof (a =
                  null !=
                  (a =
                    c(n, 'goingDurationHeight') ||
                    (null != t ? c(t, 'goingDurationHeight') : t))
                    ? a
                    : s)
                ? a.call(r, {
            ...
            u(
              'function' ==
                typeof (a =
                  null !=
                  (a =
                    c(n, 'travelBorderColor') ||
                    (null != t ? c(t, 'travelBorderColor') : t))
                    ? a
                    : s)
                ? a.call(r, {
            ...
            (null !=
            (i = (
              c(n, 'goingDuration-tmpl') ||
              (t && c(t, 'goingDuration-tmpl')) ||
              s
            ).call(r, null != t ? c(t, 'model') : t, {
        ...
        26: function (e, t, n, l, o) {
          ...
          return (
            ...
            u(
              'function' ==
                typeof (a =
                  null !=
                  (a =
                    c(n, 'comingDurationHeight') ||
                    (null != t ? c(t, 'comingDurationHeight') : t))
                    ? a
                    : s)
                ? a.call(r, {
            ...
            (null !=
            (i = (
              c(n, 'comingDuration-tmpl') ||
              (t && c(t, 'comingDuration-tmpl')) ||
              s
            ).call(r, null != t ? c(t, 'model') : t, {
      ...
      e.exports = (l.default || l).template({
        ...
        5: function (e, t, n, l, o) {
          ...
          return (
            ...
            u(
              'function' ==
                typeof (a =
                  null != (a = c(n, 'color') || (null != t ? c(t, 'color') : t))
                    ? a
                    : s)
                ? a.call(r, {
                    name: 'color',
            ...
            u(
              'function' ==
                typeof (a =
                  null !=
                  (a =
                    c(n, 'fontWeight') || (null != t ? c(t, 'fontWeight') : t))
                    ? a
                    : s)
                ? a.call(r, {
                    name: 'fontWeight',
            ...
            ';">\n                    <span style="' +
            (null !=
            (i = c(n, 'if').call(r, null != t ? c(t, 'hidden') : t, {
              name: 'if',
              hash: {},
              fn: e.program(6, o, 0),
              inverse: e.noop,
            ...
            (null !=
            (i = (
              c(n, 'timegridDisplayPrimayTime-tmpl') ||
              (t && c(t, 'timegridDisplayPrimayTime-tmpl')) ||
              s
            ).call(r, t, {
        ...
        8: function (e, t, n, l, o) {
          ...
          return (
            ...
            u(c((i = o && d(o, 'root')) && d(i, 'hourmarkerTop'), t)) +
            '%; margin-top: calc(6px - ' +
            u(
              c(
                (i = (i = o && d(o, 'root')) && d(i, 'styles')) &&
        ...
        11: function (e, t, n, l, o) {
          ...
          return (
            ...
            (null !=
            (i = (
              c(n, 'timegridDisplayTime-tmpl') ||
              (t && c(t, 'timegridDisplayTime-tmpl')) ||
              s
            ).call(r, t, {
        ...
        3: function (e, t, n, l, o) {
          ...
          return (
            ...
            u(
              typeof (i =
                null !=
                (i = c(n, 'CSS_PREFIX') || (null != t ? c(t, 'CSS_PREFIX') : t))
                  ? i
                  : r) === s
                ? i.call(a, {
                    name: 'CSS_PREFIX',
            ...
            u(
              typeof (i =
                null !=
                (i = c(n, 'bgColor') || (null != t ? c(t, 'bgColor') : t))
                  ? i
                  : r) === s
                ? i.call(a, {
                    name: 'bgColor',
            ...
            u(
              typeof (i =
                null != (i = c(n, 'name') || (null != t ? c(t, 'name') : t))
                  ? i
                  : r) === s
                ? i.call(a, {
                    name: 'name',
      ...
      e.exports = (l.default || l).template({
        1: function (e, t, n, l, o) {
          ...
          return (
            ...
            (null !=
            (i = (
              c(n, 'popupDetailLocation-tmpl') ||
              (t && c(t, 'popupDetailLocation-tmpl')) ||
              s
            ).call(r, null != t ? c(t, 'schedule') : t, {
        ...
        3: function (e, t, n, l, o) {
          ...
          return (
            ...
            (null !=
            (i = (
              c(n, 'popupDetailRepeat-tmpl') ||
              (t && c(t, 'popupDetailRepeat-tmpl')) ||
              s
            ).call(r, null != t ? c(t, 'schedule') : t, {
        ...
        7: function (e, t, n, l, o) {
          ...
          return (
            ...
            (null !=
            (i = (
              c(n, 'popupDetailState-tmpl') ||
              (t && c(t, 'popupDetailState-tmpl')) ||
              s
            ).call(r, null != t ? c(t, 'schedule') : t, {
        ...
        11: function (e, t, n, l, o) {
          ...
          return (
            ...
            (null !=
            (i = (
              c(n, 'popupDetailBody-tmpl') ||
              (t && c(t, 'popupDetailBody-tmpl')) ||
              s
            ).call(r, null != t ? c(t, 'schedule') : t, {
      ...
      (r.prototype.destroy = function () {
        ...
        (r.prototype._onClick = function (e) {
          var t,
            ...
            u = i.closest(l, o.classname('.weekday-exceed-in-week'));
          if (this.view.container.contains(l)) {
            if (!s)
              return u
                ? (this.view.setState({
                    clickedExpandBtnIndex: parseInt(i.getData(u, 'index'), 10)
                  }),
                  void n.fire('expand'))
                : void (
                    a &&
        ...
        (s.prototype.destroy = function () {
          ...
          (s.prototype._getScheduleBlockDataFunc = function (e) {
            var t = e.model,
              ...
              d =
                Math.ceil(
                  (r.getTime() - u.getTime()) / i.MILLISECONDS_PER_DAY
                ) || 0;
            return function (e) {
              return { baseWidthPercent: o, fromLeft: c + e, fromRight: d + e };
            };
          }),
          ...
          (s.prototype._onDrag = function (e) {
            var t,
              ...
              c = this._dragStartXIndex,
              d = e.datesInRange,
              h = e.grids;
            u &&
              ((n = (t = u(e.xIndex - c)).fromLeft < 0),
              (l = t.fromRight > 0),
      ...
      (d.prototype.destroy = function () {
        ...
        (d.prototype._onDragStart = function (e) {
          var t,
            ...
            d = this.controller;
          c &&
            ((t = a.closest(u, o.classname('.weekday-schedule-block'))),
            (n = a.getData(t, 'id')),
            (i = d.schedules.items[n]) &&
              ((r = this._retriveScheduleData(this.view, e.originEvent)),
              (this.getScheduleDataFunc = r),
        ...
        (d.prototype._updateSchedule = function (e) {
          var t,
            ...
            o = new c(n.end);
          (o = o.addDate(l)),
            (o = new c(r.maxDate(i.end(n.start), o))),
      ...
      (m.prototype.destroy = function () {
        ...
        (m.prototype._createSchedule = function (e) {
          var t,
            ...
            r = e.relatedView,
            s = e.createRange,
            c = e.nearestGridTimeY,
            h = e.nearestGridEndTimeY
              ? e.nearestGridEndTimeY
              : new d(c).addMinutes(30);
          s || (s = [c, h]),
            (t = new d(r.getDate())),
            (n = a.start(t)),
            (l = a.getStartOfNextDay(t)),
            (o = u.limitDate(s[0], n, l)),
            (i = u.limitDate(s[1], n, l)),
            this.fire('beforeCreateSchedule', {
              isAllDay: !1,
              start: new d(o),
              end: new d(i),
    ...
    function (e, t, n) {
      ...
      (function (t) {
        var l = n(5),
          ...
          s = n(5).ratio,
          u = n(4).Date,
          c = 60 * o.MILLISECONDS_PER_MINUTES;
        function d(e) {
        ...
        (d.prototype.destroy = function () {
          ...
          (d.prototype._refreshGuideElement = function (e, t, n, l, r) {
            ...
            (s.style.top = e + 'px'),
              ...
              r
                ? a.removeClass(u, i.classname('time-guide-bottom'))
                : a.addClass(u, i.classname('time-guide-bottom'));
          }),
          ...
          (d.prototype._getStyleDataFunc = function (e, t, n) {
            ...
            return function (n) {
              var o = n.nearestGridY,
                ...
                c = n.nearestGridEndTimeY || new u(r).addMinutes(30);
              return [
                l.limit(s(t, e, o), [0], [e]),
                l.limitDate(r, i, a),
                l.limitDate(c, i, a)
          ...
          (d.prototype._createGuideElement = function (e) {
            ...
            (t = this._styleUnit = this._getUnitData(h)),
              ...
              (s = new u(l[1]).addMinutes(o.minutesFromHours(p))),
              (d = new u(l[2]).addMinutes(o.minutesFromHours(p))),
              (a = l[0]),
              (r = (t[4] * (d - s)) / c),
      ...
      (d.prototype.destroy = function () {
        ...
        (d.prototype._onDragStart = function (e) {
          var t,
            ...
            u = a.closest(r, o.classname('.time-date-schedule-block')),
            c = this.baseController;
          s &&
            u &&
            ((l = a.getData(u, 'id')),
            (i = c.schedules.items[l]).isReadOnly ||
        ...
        (d.prototype._updateSchedule = function (e) {
          var t,
            ...
            r = a[1] - a[0],
            u = 0,
            c = l.schedules.items[o],
            d = e.relatedView,
            h = e.currentView;
          c &&
            h &&
            ((r -= i.millisecondsFrom('minutes', 30)),
            (t = new s(c.getStarts()).addMilliseconds(r)),
            (n = new s(c.getEnds()).addMilliseconds(r)),
            h && (u = h.getDate() - d.getDate()),
            t.addMilliseconds(u),
            n.addMilliseconds(u),
            this.fire('beforeUpdateSchedule', {
              schedule: c,
        ...
        (f.prototype.destroy = function () {
          ...
          (f.prototype._refreshGuideElement = function (e, t, n) {
            ...
            a.requestAnimFrame(function () {
              o._guideLayer &&
                ...
                o._guideLayer.setContent(u(l.extend({ model: t }, n))));
            });
          }),
          ...
          (f.prototype._onDrag = function (e) {
            ...
            l.browser.msie ||
              ...
              (a = Math.max(a, 0)),
              (a = Math.min(a, n)),
              (this._model.start = new c(this._model.getStarts()).addMinutes(
                h.minutesFromHours(y)
              )),
              (this._model.end = new c(this._model.getEnds()).addMinutes(
                h.minutesFromHours(y)
              )),
              (this._lastDrag = e),
          ...
          (f.prototype._resetGuideLayer = function () {
            this._guideLayer &&
              ...
              this._guideLayer.setContent(
                u(l.extend({ model: this._model }, this._viewModel))
              ),
      ...
      (d.prototype.destroy = function () {
        ...
        (d.prototype._onDragStart = function (e) {
          ...
          r &&
            ...
            (l = this._dragStart = n(e.originEvent, {
              targetModelID: t,
        ...
        (u.prototype.destroy = function () {
          ...
          (u.prototype._onDrag = function (e) {
            var t,
              ...
              a = e.relatedView,
              u = a.options,
              c = a.getViewBound().height,
              d = u.hourEnd - u.hourStart,
              h = this.guideElement,
      ...
      l.inherit(p, u),
        ...
        (p.prototype.render = function () {
          var e,
            ...
            m = u ? u.theme : null,
            f = this._getStyles(m);
          (e = this.grids = i.getGridLeftAndWidth(
            a.daynames.length,
            a.narrowWeekend,
            a.startDayOfWeek
          )),
            ...
            this.children.each(function (t) {
              var l = i.start(t.options.renderStartDate),
                ...
                r = u.findByDateRange(i.start(l), i.end(a), p),
                s = {
                  eventsInDateRange: r,
                  range: i
      ...
      e.exports = (l.default || l).template({
        ...
        10: function (e, t, n, l, o) {
          ...
          return (
            ...
            u(
              'function' ==
                typeof (a =
                  null != (a = c(n, 'ymd') || (null != t ? c(t, 'ymd') : t))
                    ? a
                    : s)
                ? a.call(r, {
                    name: 'ymd',
            ...
            (null !=
            (i = (
              c(n, 'monthGridHeaderExceed-tmpl') ||
              (t && c(t, 'monthGridHeaderExceed-tmpl')) ||
              s
            ).call(r, null != t ? c(t, 'hiddenSchedules') : t, {
        ...
        12: function (e, t, n, l, o) {
          ...
          return (
            ...
            (null !=
            (i = (
              c(n, 'monthGridFooterExceed-tmpl') ||
              (t && c(t, 'monthGridFooterExceed-tmpl')) ||
              s
            ).call(r, null != t ? c(t, 'hiddenSchedules') : t, {
        ...
        main: function (e, t, n, l, o) {
          ...
          return (
            ...
            'weekday-grid">\n' +
            (null !=
            (i = c(n, 'each').call(r, null != t ? c(t, 'dates') : t, {
              name: 'each',
              hash: {},
              fn: e.program(1, o, 0),
              inverse: e.noop,
      ...
      e.exports = (l.default || l).template({
          ...
          return (
            ...
            u(
              (
                ...
                r,
                t,
                (i = o && c(o, 'root')) && c(i, 'dates'),
                (i = o && c(o, 'root')) && c(i, 'scheduleBlockHeight'),
                (i = o && c(o, 'root')) && c(i, 'gridHeaderHeight'),
                {
            ...
            u(
              e.lambda(
                (i = o && c(o, 'root')) && c(i, 'scheduleBlockGutter'),
                t
              )
            ) +
            'px">\n' +
            (null !=
            (i = (c(n, 'fi') || (t && c(t, 'fi')) || s).call(
              r,
              null != (i = null != t ? c(t, 'model') : t)
                ? c(i, 'isAllDay')
                : i,
        ...
        10: function (e, t, n, l, o) {
          ...
          return (
            ...
            ';\n' +
            (null !=
            (i = d(n, 'unless').call(u, null != t ? d(t, 'exceedLeft') : t, {
              name: 'unless',
              hash: {},
              fn: e.program(13, o, 0),
              inverse: e.noop,
              ...
              : '') +
            (null !=
            (i = d(n, 'unless').call(u, null != t ? d(t, 'exceedRight') : t, {
              name: 'unless',
              hash: {},
              fn: e.program(15, o, 0),
              inverse: e.noop,
        ...
        24: function (e, t, n, l, o) {
          ...
          return (
            ...
            '">' +
            (null !=
            (i = (d(n, 'time-tmpl') || (t && d(t, 'time-tmpl')) || c).call(
              u,
              null != t ? d(t, 'model') : t,
              {
                name: 'time-tmpl',
        ...
        main: function (e, t, n, l, o) {
          ...
          return (
            ...
            u(
              'function' ==
                typeof (a =
                  null != (a = c(n, 'top') || (null != t ? c(t, 'top') : t))
                    ? a
                    : s)
                ? a.call(r, {
                    name: 'top',
            ...
            u(
              'function' ==
                typeof (a =
                  null !=
                  (a = c(n, 'height') || (null != t ? c(t, 'height') : t))
                    ? a
                    : s)
                ? a.call(r, {
                    name: 'height',
            ...
            ';display:none">\n' +
            (null !=
            (i = c(n, 'if').call(r, null != t ? c(t, 'isCreationMode') : t, {
              name: 'if',
              hash: {},
              fn: e.program(1, o, 0),
    ...
    function (e, t, n) {
      ...
      (d.prototype.destroy = function () {
        ...
        (d.prototype._updateSchedule = function (e) {
          var t = i.end(new u(e.end)),
            n = e.schedule,
            l = c.getScheduleChanges(n, ['end'], { end: t });
          this.fire('beforeUpdateSchedule', {
            schedule: n,
            changes: l,
        ...
        (d.prototype._onDragStart = function (e) {
          ...
          a.hasClass(i, o.classname('weekday-resize-handle')) &&
            ...
            (l.model = n),
            (this._cache = { schedule: n, target: i, start: new u(l.date) }),
    ...
    function (e, t, n) {
      ...
      (c.prototype.destroy = function () {
        ...
        (c.prototype.updateSchedule = function (e) {
          var t = e.model,
            n = t.duration(),
            l = a.raw(t.start),
            o = new u(e.end),
          ...
          i.setHours(l.h, l.m, l.s, l.ms),
            this.fire('beforeUpdateSchedule', {
              schedule: t,
              changes: { start: i, end: new u(i).addMilliseconds(n) },
              start: i,
              end: new u(i).addMilliseconds(n)
            });
        }),
        (c.prototype.getMonthScheduleBlock = function (e) {
          var t = o.classname('.weekday-schedule-block');
          return i.closest(e, t);
        }),
        (c.prototype.getMoreLayerScheduleBlock = function (e) {
          var t = o.classname('.month-more-schedule');
          return i.closest(e, t);
        }),
        (c.prototype.hasPermissionToHandle = function (e) {
          var t,
            n = null;
    ...
    function (e, t, n) {
      ...
      (function (t) {
        ...
        (c.prototype.destroy = function () {
          ...
          (c.prototype._hideOriginScheduleBlocks = function (e) {
            var t = o.classname('weekday-schedule-block-dragging-dim');
            (this.elements = i.find(
              o.classname('.weekday-schedule-block-' + e),
          ...
          (c.prototype._showOriginScheduleBlocks = function () {
            var e = o.classname('weekday-schedule-block-dragging-dim');
            l.forEach(this.elements, function (t) {
              i.removeClass(t, e);
            });
          }),
          (c.prototype._clearGridBgColor = function () {
            var e = o.classname('.weekday-filled'),
              t = o.classname('weekday-filled'),
              n = i.find(e, this.monthMove.monthView.container);
            n && i.removeClass(n, t);
          }),
          (c.prototype._updateGridBgColor = function (e) {
            var t = i.find(
          ...
          (c.prototype._onDragStart = function (e) {
            var n = this.monthMove.monthView,
              c = n.children.single(),
              d = c.options,
              h = 100 / c.getRenderDateRange().length,
      ...
      l.inherit(d, r),
        ...
        (d.prototype._getRenderPosition = function (e, t) {
          var n = i.getMousePosition(
            ...
            o = n[0] - 5,
            r = n[1] - 5;
          return [(o = u.ratio(l[0], 100, o)), (r = u.ratio(l[1], 100, r))];
        }),
        (d.prototype.destroy = function () {
          this.layer.destroy(),
            (this.layer = null),
        ...
        (d.prototype.render = function (e) {
          var t,
            ...
            r,
            s,
            u = a.closest(e.target, o.classname('.weekday-grid-line')),
            d = a.closest(u, o.classname('.month-week-item')),
            h = this.layer,
            p = this,
            m = this._getRenderPosition(u, d),
            f = a.getSize(d)[1] + 10,
            g = u.offsetWidth + 10,
            y = this.options,
            S = y.moreLayerSize,
        ...
        (d.prototype.refresh = function () {
          this._viewModel && this.layer.setContent(c(this._viewModel));
        }),
      ...
      e.exports = (l.default || l).template({
        ...
        2: function (e, t, n, l, o) {
          ...
          return (
            ...
            u(c((i = o && d(o, 'root')) && d(i, 'scheduleHeight'), t)) +
            'px; margin-top: ' +
            u(c((i = o && d(o, 'root')) && d(i, 'scheduleGutter'), t)) +
            'px; border-radius: ' +
            u(c((i = o && d(o, 'root')) && d(i, 'borderRadius'), t)) +
            ';\n' +
            (null !=
            (i = d(n, 'if').call(
              r,
        ...
        8: function (e, t, n, l, o) {
          ...
          return (
            ...
            '"\n                    data-schedule-id="' +
            u(
              c(null != (i = null != t ? h(t, 'model') : t) ? h(i, 'id') : i, t)
            ) +
            '" data-calendar-id="' +
            u(
              c(
            ...
            'weekday-schedule-time"\n                    style="height: ' +
            u(c((i = o && h(o, 'root')) && h(i, 'scheduleHeight'), t)) +
            'px; line-height: ' +
            u(c((i = o && h(o, 'root')) && h(i, 'scheduleHeight'), t)) +
            'px; margin-top: ' +
            u(c((i = o && h(o, 'root')) && h(i, 'scheduleGutter'), t)) +
            'px;' +
            u(
              c(
                null != (i = null != t ? h(t, 'model') : t)
            ...
            'weekday-schedule-bullet"\n                        style="top: ' +
            u(c((i = o && h(o, 'root')) && h(i, 'scheduleBulletTop'), t)) +
            'px;\n' +
            (null !=
            (i = h(n, 'if').call(
              r,
