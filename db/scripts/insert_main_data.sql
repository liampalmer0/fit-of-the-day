...
(4, 'Green Shirt', 'A very good green shirt', 'f', 1, 'green', 1, 5, 60, 80, 's-green.png'),
(4, 'Black Jeans', 'Very black jeans', 'f', 2, 'black', 1, 5, 20, 75, 'p-j-black.png'),
(4, 'Blue Shirt', 'A very good blue shirt', 'f', 1, 'blue', 1, 5, 60, 80, 's-blue.png'),
(4, 'Brown Pants', 'Very good khakis', 'f', 2, 'brown', 1, 5, 20, 75, 'p-brown.png'),
(4, 'Yellow Shirt', 'A very good yellow shirt', 'f', 1, 'yellow', 1, 5, 60, 80, 's-yellow.png'),
(4, 'Orange Shirt', 'A very good orange shirt', 'f', 1, 'orange', 1, 5, 60, 80, 's-orange.png'),
(4, 'Red Shirt', 'A very good red shirt', 'f', 1, 'red', 1, 5, 60, 80, 's-red.png'),
(4, 'Black Shirt', 'A very good black shirt', 'f', 1, 'black', 1, 5, 60, 80, 's-black.png'),
(4, 'Blue Jeans', 'Very good blue jeans', 'f', 2, 'blue', 1, 5, 20, 75, 'p-j-blue.png'),
