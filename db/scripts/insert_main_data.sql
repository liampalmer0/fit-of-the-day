...
INSERT INTO article ("closetId", "name", "desc", dirty, "garmentTypeId", "dressCodeId", "ratingId", "tempMin", "tempMax", filepath)
VALUES 
(1, 'Green Shirt', 'A very good green shirt', 'f', 1, 1, 5, 60, 80, 's-green.png'),
(1, 'Black Jeans', 'Very black jeans', 'f', 2, 1, 5, 20, 75, 'p-j-black.png'),
(1, 'Blue Shirt', 'A very good blue shirt', 'f', 1,  1, 5, 60, 80, 's-blue.png'),
(1, 'Brown Pants', 'Very good khakis', 'f', 2, 1, 5, 20, 75, 'p-brown.png'),
(1, 'Yellow Shirt', 'A very good yellow shirt', 'f', 1,  1, 5, 60, 80, 's-yellow.png'),
(1, 'Orange Shirt', 'A very good orange shirt', 'f', 1, 1, 5, 60, 80, 's-orange.png'),
(1, 'Red Shirt', 'A very good red shirt', 'f', 1, 1, 5, 60, 80, 's-red.png'),
(1, 'Black Shirt', 'A very good black shirt', 'f', 1, 1, 5, 60, 80, 's-black.png'),
(1, 'Blue Jeans', 'Very good blue jeans', 'f', 2, 1, 5, 20, 75, 'p-j-blue.png'),
(1, 'White Shirt', 'A very good white shirt', 'f', 1, 1, 5, 60, 80, 's-white.png'),
(1, 'Blue Chino', 'Very good blue chinos', 'f', 2, 1, 5, 20, 75, 'p-c-blue.png'),
(1, 'Black Chino', 'Very good black chinos', 'f', 2, 1, 5, 20, 75, 'p-c-black.png'),
(1, 'Overcoat', 'A collared winter Coat', 'f', 1,  2, 5, 0, 45, 's-null.png'),
(1, 'Long Sleeve', 'A long sleeve shirt', 'f', 1, 1, 5, 40, 65, 's-null.png'),
(1, 'Hoodie', 'A pullover hoodie', 'f', 1,  1, 5, 40, 65, 's-null.png'),
(1, 'Sweater', 'Knit sweater', 'f', 1, 1, 5, 35, 55, 's-null.png'),
(1, 'Coat', 'A lightweight coat', 'f', 1,  1, 5, 20, 55, 's-null.png'),
(1, 'Shorts', 'Cotton shorts', 'f', 2,  1, 5, 70, 100, 'p-null.png'),
(1, 'Track pants', 'black track pants', 'f', 2, 1, 5, 35, 75, 'p-null.png'),
(1, 'OP1', 'one piece', 'f', 3, 1, 5, 60, 95, 'p-null.png'),
(1, 'OP2', 'one piece', 'f', 3, 1, 5, 60, 95, 'p-null.png'),
(1, 'OP3', 'one piece', 'f', 3, 1, 5, 60, 95, 'p-null.png'),
(1, 'OP4', 'one piece', 'f', 3, 1, 5, 60, 95, 'p-null.png');
